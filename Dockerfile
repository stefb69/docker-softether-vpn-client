...
### SETUP
RUN apt -y update && apt -y install cmake gcc g++ make libncurses5-dev libssl-dev isc-dhcp-client libsodium-dev pkg-config libreadline-dev zlib1g-dev supervisor git && \
