...
### SETUP
RUN apt -y update && apt -y install cmake gcc g++ make libncurses5-dev libssl-dev isc-dhcp-common libsodium-dev pkg-config libreadline-dev zlib1g-dev supervisor git && \
